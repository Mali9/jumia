...
<div class="col-md-12">
    ...
    <div class="card card-info">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form class="form-horizontal" enctype='multipart/form-data' method="POST" action="{{ url('/store_package') }}">
            @csrf
            <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-6 form-group mb-3 rawy">
                            ...
                            <input required class="form-control" style="margin-bottom: 20px" name="description[]"
                                type="text" value="{{ Request::old('description') }}" id="name">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="description" rows="15" class="form-control" id="description"
                            placeholder="وصف الباقة ">{{ old('description') }}</textarea>
                @error('description')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input required type="number" step="any" name="price" value="{{ old('price') }}" class="form-control"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input required type="number" step="any" name="duration" value="{{ old('duration') }}" class="form-control"
