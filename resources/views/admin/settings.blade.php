      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="card card-primary">
            ...
            {{-- <form role="form" action="{{ url('update_site_settings') }}" method="POST" enctype="multipart/form-data">

              @csrf
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">عنوان الموقع</label>
                  <input required type="text" name="site_title" class="form-control" value="{{ $settings->site_title }}"
