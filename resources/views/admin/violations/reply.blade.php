...
<div class="col-md-12">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">الرد على المخالفة </h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form class="form-horizontal" enctype='multipart/form-data' method="POST"
            action="{{ url('/store_violation_reply') }}">
            <div class="card-body">
                ...
                <input name="violation_id" type="hidden" value="{{ $violation_id }}" />
            </div>
            <!-- /.card-body -->
            <div class="card-footer">
                <button type="submit" class="btn btn-primary"> رد </button>
                <a class="btn btn-danger float-left" href=" {{ action('Admin\ViolationController@index') }} "> إلغاء
                </a>
            </div>
            <!-- /.card-footer -->
        </form>
