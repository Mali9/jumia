...
<div class="col-md-12">
    ...
    <div class="card card-info">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form class="form-horizontal" enctype='multipart/form-data' method="POST" action="{{ url('/store_bar') }}">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <div class="mb-5">
                                <textarea id="editor1" name="body" rows="20"></textarea>
                            </div>
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-danger float-left" href=" {{ url('/all-bars') }} "> إلغاء </a> </div>
            <!-- /.card-footer -->
        </form>
    </div>
</div>
