        ...
        <form class="form-horizontal" enctype='multipart/form-data' method="POST"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" value="{{ $user->credit }}" name="credit" class="form-control" id="credit"
                            placeholder="0">
                        @error('credit')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="type" id="type" class="form-control">
                            <option value="user" {{ $user->type == 'user' ? 'selected' : '' }}>مشترك
                            </option>
                            {{-- <option value="sub_admin"
                                    {{ $user->type == 'sub_admin' ? 'selected' : '' }}>مشرف
                            </option>
