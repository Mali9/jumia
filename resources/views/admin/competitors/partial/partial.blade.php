            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div style="float: left">
                        <a href="{{ url('/add_competitor') }}" class="btn btn-block btn-info btn-lg">أضافة</a>
                    </div>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" role="menu">
                                                            <a class="dropdown-item"
                                                                href="{{ url('/edit_competitor') }}/{{ $user->id }}">تعديل</a>
                                                            <a class="dropdown-item delete"
                                                                href="{{ url('/delete_competitor') }}/{{ $user->id }}">حذف</a>
                                                            @if ($user->status == 1)
                                                                <a class="dropdown-item"
                                                                    href="{{ url('/change_competitor_status') }}/{{ $user->id }}">تعطيل</a>
                                                            @else
                                                                <a class="dropdown-item"
                                                                    href="{{ url('/change_competitor_status') }}/{{ $user->id }}">تنشيط</a>
                                                            @endif
                                                            @if ($user->type == 'sub_admin')
                                                                <a class="dropdown-item"
                                                                    href="{{ url('/show_competitor') }}/{{ $user->id }}">الصلاحيات</a>
