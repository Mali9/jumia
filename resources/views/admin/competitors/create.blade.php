    ...
    <div class="col-md-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">أضف مشترك جديد </h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" enctype='multipart/form-data' method="POST" action="{{ url('/store_competitor') }}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="credit" class="col-sm-2 control-label"> الرصيد </label>

                        <div class="col-sm-10">
                            <input type="number" value="{{ old('credit') }}" name="credit" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="type" id="type" class="form-control">
                                <option value="user" {{ old('type') == 'user' ? 'selected' : '' }}>مشترك
                                </option>
                                {{-- <option value="sub_admin"
                                    {{ old('type') == 'sub_admin' ? 'selected' : '' }}>مشرف
                                </option>
