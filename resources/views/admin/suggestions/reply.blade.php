    ...
    <div class="col-md-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">الرد على الاقتراح </h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" enctype='multipart/form-data' method="POST" action="{{ url('/store_suggestion_reply') }}">
                <div class="card-body">
                    ...
                    <input name="suggestion_id" type="hidden" value="{{ $suggestion_id }}" />
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary"> رد </button>
                    <a class="btn btn-danger float-left" href=" {{ action('Admin\SuggestionController@index') }} "> إلغاء
                    </a>
                </div>
                <!-- /.card-footer -->
            </form>
